...
passport_1.default.use(new passport_spotify_1.Strategy({
    ...
    var user = { profile: profile, accessToken: accessToken, refreshToken: refreshToken, expires_in: 5000 };
...
app.use('/auth/spotify', passport_1.default.authenticate('spotify'), routes_1.default);
